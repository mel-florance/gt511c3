	...
	Controller()
{
	...
	atlas->addItem("connected", 17, 20);
	atlas->addItem("disconnected", 17, 19);

	std::cout << "Loaded icons" << std::endl;
}

void IconsController::drawIcon(
...
void IconsController::OnEvent(Event& event)
{
}

void IconsController::OnUpdate(float delta)
{
}

void IconsController::OnRender()
{
